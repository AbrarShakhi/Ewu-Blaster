...
PositionRect::PositionRect() : PositionRect({0, 0}, {1, 1}) {
}

PositionRect::PositionRect(olc::vf2d p_pos) : PositionRect(p_pos, {1, 1}) {
}

PositionRect::PositionRect(olc::vf2d p_pos, olc::vf2d p_scale) {
	position = p_pos;
	scale = p_scale;
}

void PositionRect::setScalingLockCenter(olc::vf2d p_new_scale) {
	olc::vf2d prev_center = center();
	scale = p_new_scale;
	setCenter(prev_center);
}
